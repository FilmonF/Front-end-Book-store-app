...
const Home = () => {
  ...
  const usernameLocal = localStorage.getItem('token') || sessionStorage.getItem('token');
  ...
  const fetchBooks = async () => {
    if (token) {
      setLoading(true);
      try {
        const response = await axios.get('https://backend-book-store-app.onrender.com/books', {
